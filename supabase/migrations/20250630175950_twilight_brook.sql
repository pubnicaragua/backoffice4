/*
  # Create additional tables for complete CRUD functionality

  1. New Tables
    - `turnos` - Employee shifts management
    - `tareas` - Tasks management
    - `permisos` - Permissions system
    - `usuario_permisos` - User permissions relationship
  ...
  3. Sample Data
    - Add sample permissions, tasks, and vacation requests
*/
