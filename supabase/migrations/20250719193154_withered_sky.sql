/*
  # Fix UUID Format Error in POS Integration
  
  1. Create POS tables with correct UUID format
  2. Insert sample data with valid UUIDs
  3. Add CAF integration for electronic receipts
  4. Complete POS integration system
*/
...
-- Create CAF files table for SII integration
...
-- Insert POS terminals with correct UUID casting
...
-- Insert sample transactions with VALID UUIDs (using gen_random_uuid())
INSERT INTO pos_transactions (terminal_id, transaction_type, payment_provider_id, external_transaction_id, amount, payment_method, status, provider_response) VALUES
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'sale', '22222222-2222-2222-2222-222222222222', 'sumup_tx_12345', 15000.00, 'card', 'approved', '{"card_type": "credit", "last_4": "1234", "authorization_code": "ABC123"}'),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'sale', '22222222-2222-2222-2222-222222222222', 'sumup_tx_12346', 8500.00, 'card', 'approved', '{"card_type": "debit", "last_4": "5678", "authorization_code": "DEF456"}'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'sale', '22222222-2222-2222-2222-222222222222', 'sumup_tx_12347', 25000.00, 'card', 'approved', '{"card_type": "credit", "last_4": "9012", "authorization_code": "GHI789"}');

-- Insert sync logs with auto-generated UUIDs
INSERT INTO pos_sync_log (terminal_id, sync_type, direction, status, records_count, sync_data) VALUES
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'products', 'to_pos', 'success', 5, '{"products_synced": ["PROD001", "PROD002", "PROD003", "PROD004", "PROD005"]}'),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'transactions', 'from_pos', 'success', 3, '{"transactions_received": 3, "total_amount": 48500}'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'promotions', 'to_pos', 'success', 2, '{"promotions_synced": ["PROMO001", "PROMO002"]}');

-- Insert terminal sessions
INSERT INTO terminal_sessions (terminal_id, usuario_id, cash_opening, total_sales, total_transactions, status) VALUES
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '80ca7f2b-d125-4df6-9f22-a5fe3ada00e4', 50000.00, 48500.00, 3, 'active'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '11111111-1111-1111-1111-111111111111', 30000.00, 25000.00, 1, 'active');
...
INSERT INTO folios_electronicos (caf_id, folio, tipo_documento)
SELECT 
  '11111111-1111-1111-1111-111111111111',
