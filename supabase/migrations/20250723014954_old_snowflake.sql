/*
  # Fix Missing Columns - Final Correction
  ...
  2. Update Existing Data
    - Set default values without referencing non-existent columns
*/
...
UPDATE promociones SET costo = 1000, disponible = true WHERE costo IS NULL OR costo = 0;
